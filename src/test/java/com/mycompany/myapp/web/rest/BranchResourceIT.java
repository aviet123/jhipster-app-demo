...
class BranchResourceIT {
    ...
    void createBranch() throws Exception {
        ...
        assertThat(testBranch.getCityId()).isEqualTo(DEFAULT_CITY_ID);
        assertThat(testBranch.getDistrictId()).isEqualTo(DEFAULT_DISTRICT_ID);
    }
    ...
    void putNewBranch() throws Exception {
        ...
        assertThat(testBranch.getCityId()).isEqualTo(UPDATED_CITY_ID);
        assertThat(testBranch.getDistrictId()).isEqualTo(UPDATED_DISTRICT_ID);
    }
