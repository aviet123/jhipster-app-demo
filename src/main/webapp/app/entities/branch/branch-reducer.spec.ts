...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_BRANCH),
          REQUEST(ACTION_TYPES.UPDATE_BRANCH),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BRANCH),
          REQUEST(ACTION_TYPES.DELETE_BRANCH),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_BRANCH),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_BRANCH actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BRANCH),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_BRANCH),
          payload: resolvedObject,
        },
      ];
